...
(window.Modernizr = (function (a, b, c) {
      ...
      function d (d, e) {
        ...
        return f ||
          (e.setAttribute || (e = b.createElement ('div')), e.setAttribute &&
            e.removeAttribute &&
            (e.setAttribute (d, ''), (f = E (e[d], 'function')), E (
              e[d],
              'undefined'
  ...
  !E (A, 'undefined') && !E (A.call, 'undefined')
    ...
    return C ('background-color:rgba(150,255,150,.5)'), F (
      j.backgroundColor,
      'rgba'
    );
  }), (s.hsla = function () {
    return C ('background-color:hsla(120,40%,100%,.5)'), F (
      j.backgroundColor,
      'rgba'
  ...
  for (var K in s)
    B (s, K) &&
      ((x = K.toLowerCase ()), (e[x] = s[K] ()), v.push (
        (e[x] ? '' : 'no-') + x
      ));
  return e.input || J (), (e.addTest = function (a, b) {
    ...
    function r (a) {
      ...
      return s.shivCSS &&
        ...
        (c.hasCSS = !!l (
          a,
          'article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#222}template{display:none}'
        )), k || q (a, c), a;
    }
    var c = '3.7.0',
      d = a.html5 || {},
    ...
    this,
    b
  ), (e._version = d), (e._prefixes = n), (e._domPrefixes = q), (e._cssomPrefixes = p), (e.hasEvent = z), (e.testProp = function (
    a
  ) {
    return G ([a]);
  }), (e.testAllProps = I), (e.testStyles = y), (e.prefixed = function (
    a,
    b,
    c
  ) {
...
!function () {
  ...
  (a = jQuery), (a.fn.flexNav = function (b) {
    ...
    return (k = a.extend (
      ...
      if (a (window).width () <= e)
        return c
          ...
          .addClass ('sm-screen'), k.calcItemWidths === !0 &&
          d.css ('width', '100%'), (b =
          k.buttonSelector + ', ' + k.buttonSelector + ' .touch-button'), a (
          b
      ...
      if (a (window).width () > e) {
        if (
          (jQuery ('#header-container').removeClass ('light-content'), jQuery (
            '#menu-burger'
          ).removeClass ('open'), jQuery ('nav').removeClass (
            'open'
          ), c
            .removeClass ('sm-screen')
            .addClass ('lg-screen'), k.calcItemWidths === !0 &&
            d.css ('width', g), c
            .removeClass ('flexnav-show')
            .find ('.item-with-ul')
            .on (), a ('.item-with-ul')
            .find ('ul')
            .removeClass ('flexnav-show'), i (), k.hoverIntent === !0)
        )
    ...
    }), a (k.buttonSelector).data ('navEl', c), (n =
      '.item-with-ul, ' + k.buttonSelector), a (n).append (
      '<span class="touch-button"><i class="navicon">&#9660;</i></span>'
    ), (m = k.buttonSelector + ', ' + k.buttonSelector + ' .touch-button'), a (
      m
    ).on ('click', function (b) {
      var c, d, e;
      return a (m).toggleClass (
        'active'
      ), b.preventDefault (), b.stopPropagation (), (e = k.buttonSelector), (c = a (this).is (e) ? a (this) : a (this).parent (e)), (d = c.data ('navEl')), d.toggleClass ('flexnav-show');
      ...
      return (b = a (this)
        ...
        .find (
          '>ul'
        )), (d = a (this).parent ('.item-with-ul').find ('>span.touch-button')), c.hasClass ('lg-screen') === !0 && a (this).parent ('.item-with-ul').siblings ().find ('ul.flexnav-show').removeClass ('flexnav-show').hide (), b.hasClass ('flexnav-show') === !0 ? (b.removeClass ('flexnav-show').slideUp (k.animationSpeed), d.removeClass ('active')) : b.hasClass ('flexnav-show') === !1 ? (b.addClass ('flexnav-show').slideDown (k.animationSpeed), d.addClass ('active')) : void 0;
      ...
      return a (this)
        ...
        .not (this)
        .removeClass ('open')
        .hide (), a (this).parent ('.item-with-ul').find ('>ul').addClass ('open').show ();
  ...
  (a.waitForImages = {
    ...
    if (
      (a.isPlainObject (arguments[0])
        ? ((e = arguments[0].waitForAll), (d = arguments[0].each), (c =
            arguments[0].finished))
        : 1 === arguments.length && 'boolean' === a.type (arguments[0])
            ? (e = arguments[0])
            : ((c = arguments[0]), (d = arguments[1]), (e = arguments[2])), (c =
        c || a.noop), (d = d || a.noop), (e = !!e), !a.isFunction (c) ||
        !a.isFunction (d))
    )
      ...
      e
        ? i.find ('*').addBack ().each (function () {
            ...
            b.is ('img:uncached') &&
              ...
              var e, f = b.attr (d);
              return f
                ? ((e = f.split (',')), void a.each (e, function (c, d) {
                    (d = a
                      .trim (d)
                      .split (' ')[0]), j.push ({src: d, element: b[0]});
                  }))
                : !0;
            });
          })
        ...
        j.length), (g = 0), 0 === f && (c.call (i[0]), h.resolveWith (i[0])), a.each (
        j,
        function (e, j) {
          ...
          a (k).one (l, function m (b) {
            ...
            return g++, d.apply (
              j.element,
              e
            ), h.notifyWith (j.element, e), a (this).off (l, m), g == f ? (c.call (i[0]), h.resolveWith (i[0]), !1) : void 0;
          }), (k.src = j.src);
        }
      );
    }), h.promise ();
...
!(function (e) {
  ...
  var r = function (t, i) {
    (this.settings = i), this.checkSettings (), (this.imgAnalyzerTimeout = null), (this.entries = null), (this.buildingRow = {
      ...
      every: 2,
      flushed: 0,
    }), (this.border = 0 <= i.border
      ? i.border
      : i.margins), (this.maxRowHeight = this.retrieveMaxRowHeight ()), (this.suffixRanges = this.retrieveSuffixRanges ()), (this.offY = this.border), (this.rows = 0), (this.spinner = {
      phase: 0,
      timeSlot: 150,
      $el: g (
  ...
  (r.prototype.getSuffix = function (t, i) {
    ...
    if (this.settings.thumbnailPath)
      ...
      (n = t.replace (this.settings.extension, '')), (n = this.removeSuffix (
        n,
        this.getUsedSuffix (n)
    ...
    if (null !== o) {
      o.css ('width', s), o.css ('height', n), o.css (
        'margin-left',
        -s / 2
    ...
    if (null !== i && this.settings.captions) {
      ...
      if (null === e) {
        var s = i.attr ('alt');
        this.isValidCaption (s) || (s = t.attr ('title')), this.isValidCaption (
          s
        ) &&
          ((e = g ('<div class="caption">' + s + '</div>')), t.append (
            e
    ...
    void 0 === i &&
      ...
      }), t.on ('mouseenter', void 0, void 0, i.mouseenter), t.on (
        'mouseleave',
        void 0,
        void 0,
        i.mouseleave
    ...
    var i = t.data ('jg.captionMouseEvents');
    void 0 !== i &&
      (t.off ('mouseenter', void 0, i.mouseenter), t.off (
        'mouseleave',
        void 0,
        i.mouseleave
    ...
    if (t && 'hide' === this.settings.lastRow && !u) {
      for (i = 0; i < this.buildingRow.entriesBuff.length; i++)
        (e = this.buildingRow.entriesBuff[i]), this.settings.cssAnimation
          ? e.removeClass ('entry-visible')
          : (e.stop ().fadeTo (0, 0.1), e
              .find ('> img, > a > img')
              .fadeTo (0, 0));
      return -1;
    }
    for (
        ...
        ((o = !1), 0 < this.rows &&
          (o =
            (g =
              ...
              h >
            this.settings.justifyThreshold)), (i = 0);
      ...
      (s =
        ...
        e.data ('jg.height')), o
        ? ((n = i === this.buildingRow.entriesBuff.length - 1
            ? h
            : l * s), (r = l))
        : ((n = g * s), (r = g)), (h -= Math.round (n)), e.data (
        'jg.jwidth',
        Math.round (n)
      ), e.data ('jg.jheight', Math.ceil (r)), (0 === i || r < a) && (a = r);
    return (this.buildingRow.height = a), o;
  }), (r.prototype.flushRow = function (t) {
    var i, e, s, n = this.settings, r = this.border;
    if (
      ((e = this.prepareBuildingRow (t)), t && 'hide' === n.lastRow && -1 === e)
    )
      ...
      if (
        (this.maxRowHeight &&
          ...
          (this.buildingRow.height = this.maxRowHeight), t &&
      ...
      for (s = 0; s <= a; s++)
        (i = this.buildingRow.entriesBuff[
          this.settings.rtl ? a - s : s
        ]), this.displayEntry (
          i,
          r,
          this.offY,
      ...
      (this.galleryHeightToSet =
        this.offY +
        this.buildingRow.height +
        this.border), this.setGalleryTempHeight (
        this.galleryHeightToSet + this.getSpinnerHeight ()
      ), (!t || (this.buildingRow.height <= n.rowHeight && e)) &&
        ((this.offY +=
          this.buildingRow.height +
          n.margins), (this.rows += 1), this.clearBuildingRow (), this.settings.triggerEvent.call (
          this,
          'jg.rowflush'
        ));
    }
  ...
  (r.prototype.rememberGalleryHeight = function () {
    ...
    clearInterval (
      this.spinner.intervalId
    ), (this.spinner.intervalId = null), this.setGalleryTempHeight (
      this.$gallery.height () - this.getSpinnerHeight ()
    ), this.spinner.$el.detach ();
  }), (r.prototype.startLoadingSpinnerAnimation = function () {
    var t = this.spinner, i = t.$el.find ('span');
    clearInterval (t.intervalId), this.$gallery.append (
      t.$el
      ...
      t.phase < i.length
        ...
        : i
            .eq (t.phase - i.length)
            .fadeTo (t.timeSlot, 0), (t.phase = (t.phase + 1) % (2 * i.length));
    }, t.timeSlot));
  }), (r.prototype.rewind = function () {
    (this.lastFetchedEntry = null), (this.lastAnalyzedIndex = -1), (this.offY = this.border), (this.rows = 0), this.clearBuildingRow ();
  }), (r.prototype.updateEntries = function (t) {
    var i;
    return t && null != this.lastFetchedEntry
      ? (i = g (this.lastFetchedEntry)
          .nextAll (this.settings.selector)
          .toArray ())
      : ((this.entries = []), (i = this.$gallery
          .children (this.settings.selector)
          .toArray ())), 0 < i.length &&
      (g.isFunction (this.settings.sort)
        ? (i = this.sortArray (i))
        : this.settings.randomize &&
            (i = this.shuffleArray (i)), (this.lastFetchedEntry =
        i[i.length - 1]), this.settings.filter
        ? (i = this.filterArray (i))
        : this.resetFilters (i)), (this.entries = this.entries.concat (i)), !0;
    ...
    for (i = t.length - 1; 0 < i; i--)
      (e = Math.floor (Math.random () * (i + 1))), (s = t[i]), (t[i] =
        t[e]), (t[e] = s);
    ...
    clearInterval (this.checkWidthIntervalId), g.each (
      this.entries,
      g.proxy (function (t, i) {
        ...
        e.css (
          'width',
          ''
        ), e.css ('height', ''), e.css ('top', ''), e.css ('left', ''), e.data ('jg.loaded', void 0), e.removeClass ('jg-entry');
        var s = this.imgFromEntry (e);
        s.css (
          'width',
          ''
        ), s.css ('height', ''), s.css ('margin-left', ''), s.css ('margin-top', ''), s.attr ('src', s.data ('jg.originalSrc')), s.data ('jg.originalSrc', void 0), this.removeCaptionEventsHandlers (e);
        var n = this.captionFromEntry (e);
        e.data ('jg.createdCaption')
          ? (e.data ('jg.createdCaption', void 0), null !== n && n.remove ())
          : null !== n && n.fadeTo (0, 1);
      }, this)
    ), this.$gallery.css ('height', ''), this.$gallery.removeClass (
      'justified-gallery'
    ...
    for (var i = this.lastAnalyzedIndex + 1; i < this.entries.length; i++) {
      ...
      if (!0 === e.data ('jg.loaded') || 'skipped' === e.data ('jg.loaded')) {
        ...
        this.buildingRow.entriesBuff.push (
          e
        ), (this.buildingRow.aspectRatio += n), (this.buildingRow.width +=
          n * this.settings.rowHeight), (this.lastAnalyzedIndex = i);
      } else if ('error' !== e.data ('jg.loaded')) return;
    }
    0 < this.buildingRow.entriesBuff.length &&
      this.flushRow (!0), this.isSpinnerActive () &&
      this.stopLoadingSpinnerAnimation (), this.stopImgAnalyzerStarter (), this.settings.triggerEvent.call (
      this,
      t ? 'jg.resize' : 'jg.complete'
    ), this.setGalleryFinalHeight (this.galleryHeightToSet);
  }), (r.prototype.stopImgAnalyzerStarter = function () {
    (this.yield.flushed = 0), null !== this.imgAnalyzerTimeout &&
      (clearTimeout (
    ...
    g.each (this.entries, function (t, i) {
      ...
      if (
        (e.addClass ('jg-entry'), !0 !== e.data ('jg.loaded') &&
          'skipped' !== e.data ('jg.loaded'))
      )
        if (
          (null !== l.settings.rel && e.attr ('rel', l.settings.rel), null !==
            l.settings.target && e.attr ('target', l.settings.target), null !==
            s)
        ) {
          ...
          if ((s.attr ('src', n), !1 === l.settings.waitThumbnailsLoad)) {
            ...
            if (!isNaN (r) && !isNaN (o))
              return e.data ('jg.width', r), e.data ('jg.height', o), e.data (
                'jg.loaded',
                'skipped'
              ), (h = !0), l.startImgAnalyzer (!1), !0;
          }
          e.data ('jg.loaded', !1), (a = !0), l.isSpinnerActive () ||
            l.startLoadingSpinnerAnimation (), l.onImageEvent (
            n,
            function (t) {
              e.data ('jg.width', t.width), e.data (
                'jg.height',
                t.height
              ), e.data ('jg.loaded', !0), l.startImgAnalyzer (!1);
            },
            function () {
    ...
    if (
      ('string' === g.type (t[i]) && (t[i] = parseFloat (t[i])), 'number' !==
        g.type (t[i]))
    )
    ...
    this.checkSizeRangesSuffixes (), this.checkOrConvertNumber (
      this.settings,
      'rowHeight'
    ...
    if (
      (this.checkOrConvertNumber (this.settings, 'justifyThreshold'), this
        .settings.justifyThreshold < 0 || 1 < this.settings.justifyThreshold)
    )
    ...
    (this.settings = g.extend (
      ...
      this.settings,
      t
    )), this.checkSettings (), (this.border = 0 <= this.settings.border
      ? this.settings.border
      : this.settings
          .margins), (this.maxRowHeight = this.retrieveMaxRowHeight ()), (this.suffixRanges = this.retrieveSuffixRanges ());
    ...
    return this.each (function (t, i) {
      ...
      if (void 0 === s) {
        ...
        (s = new r (e, g.extend ({}, r.prototype.defaults, n))), e.data (
          'jg.controller',
          s
        );
      } else if ('norewind' === n);
...
!(function (a, b, c) {
  function d (a, c) {
    var d = b (a);
    d.data (f, this), (this._$element = d), (this.shares = []), this._init (
      c
    ), this._render ();
  }
  var e = 'JSSocials',
  ...
  (d.prototype = {
    ...
    _init: function (a) {
      this._initDefaults (), b.extend (
        this,
        a
      ), this._initShares (), this._attachWindowResizeCallback ();
    },
    _initDefaults: function () {
      (this.url = a.location.href), (this.text = b.trim (
    ...
    _windowResizeHandler: function () {
      (b.isFunction (this.showLabel) || b.isFunction (this.showCount)) &&
        (a.clearTimeout (this._resizeTimer), (this._resizeTimer = setTimeout (
          b.proxy (this.refresh, this),
          this.resizeTimeout
        )));
    },
    _render: function () {
      this._clear (), this._defineOptionsByScreen (), this._$element.addClass (
        this.elementClass
      ), (this._$shares = b ('<div>')
        .addClass (this.sharesClass)
        .appendTo (this._$element)), this._renderShares ();
    },
    _defineOptionsByScreen: function () {
      (this._screenWidth = b (a).width ()), (this._showLabel = g (
        this.showLabel,
        this,
        this._screenWidth
    ...
    _renderShare: function (a) {
      var c;
      (c = b.isFunction (a.renderer)
        ? b (a.renderer ())
        : this._createShare (a)), c
    ...
    _createShare: function (a) {
      ...
      if (this._showCount) {
        ...
        f.addClass (
          e ? this.shareLinkCountClass : this.shareCountBoxClass
    ...
    _createShareLink: function (a) {
      ...
      return d
        ...
        .append (this._createShareLogo (a)), this._showLabel &&
        d.append (this._createShareLabel (a)), b.each (this.on || {}, function (
        c,
        e
      ) {
    ...
    _renderShareCount: function (a, c) {
      ...
      c.addClass (this.shareZeroCountClass).append (d), this._loadCount (
        a
      ).done (
        b.proxy (function (a) {
    ...
    destroy: function () {
      this._clear (), this._detachWindowResizeCallback (), this._$element
    ...
    option: function (a, b) {
      return 1 === arguments.length
        ? this[a]
        : ((this[a] = b), this._passOptionToShares (
            a,
            b
          ), void this.refresh ());
    },
    shareOption: function (a, b, c) {
      return (a = this._normalizeShare (a)), 2 === arguments.length
        ? a[b]
        : ((a[b] = c), void this.refresh ());
    },
  ...
  var l = function (a) {
    ...
    b.isPlainObject (a)
      ? (c = d.prototype)
      : ((c = k[a]), (a = arguments[1] || {})), b.extend (c, a);
  },
    m = {
      popup: function (c) {
...
class GridToFullscreenEffect {
  constructor (e, n, t = {}) {
    (this.container = e), (this.itemsWrapper = n), (this.itemsWrapperChildren = n.querySelectorAll (
      '.trigger-item'
    )), (this.initialised = !1), (this.camera = null), (this.scene = null), (this.renderer = null), (t.scrollContainer =
      t.scrollContainer || null), (t.timing = t.timing || {}), (t.timing.type =
      t.timing.type || 'sameEnd'), (t.timing.sections =
      t.timing.sections || 1), (t.timing.latestStart =
      t.timing.latestStart || 0.5), (t.timing.duration =
      t.timing.duration ||
      1), (t.transformation = t.transformation || {}), (t.transformation.type =
      t.transformation.type || 'none'), (t.transformation.props = t
      .transformation.props || {}), (t.activation.type =
      t.activation.type || 'none'), (t.seed =
      t.seed || 0), (t.easings = t.easings || {}), (t.easings.toFullscreen =
      t.easings.toFullscreen || Power0.easeNone), (t.easings.toGrid =
      t.easings.toGrid ||
      Power0.easeNone), (t.flipBeizerControls = t.flipBeizerControls || {}), (t.flipBeizerControls.c0 = t
      .flipBeizerControls.c0 || {}), (t.flipBeizerControls.c0.x =
      t.flipBeizerControls.c0.x || 0.5), (t.flipBeizerControls.c0.y =
      t.flipBeizerControls.c0.y || 0.5), (t.flipBeizerControls.c1 = t
      .flipBeizerControls.c1 || {}), (t.flipBeizerControls.c1.x =
      t.flipBeizerControls.c1.x || 0.5), (t.flipBeizerControls.c1.y =
      t.flipBeizerControls.c1.y || 0.5), (this.options = t), (this.uniforms = {
    ...
    }), (this.textures = []), (this.currentImageIndex = -1), (this.isFullscreen = !1), (this.isAnimating = !1), (this.onResize = this.onResize = this.onResize.bind (
      this
    ));
  }
  resetUniforms () {
    (this.uniforms.uMeshScale.value = new THREE.Vector2 (
      1,
      1
    )), (this.uniforms.uPlaneCenter.value = new THREE.Vector2 (
      0,
      0
    )), (this.uniforms.uScaleToViewSize.value = new THREE.Vector2 (
      1,
      1
    )), (this.uniforms.uClosestCorner.value = 0), (this.uniforms.uMouse.value = new THREE.Vector2 (
      0,
      0
    )), (this.uniforms.uImage.value = null), (this.uniforms.uImageRes.value = new THREE.Vector2 (
      1,
      1
    )), (this.uniforms.uImageLarge.value = null), (this.uniforms.uImageLargeRes.value = new THREE.Vector2 (
      1,
      1
    ));
    const e = this.mesh;
  ...
  createTextures (e) {
    ...
    for (let t = 0; t < e.length; t++) {
      const r = e[t], i = new THREE.Texture (r.large.image);
      (i.generateMipmaps = !1), (i.wrapS = i.wrapT =
        THREE.ClampToEdgeWrapping), (i.minFilter =
        THREE.LinearFilter), (i.needsUpdate = !0);
      const o = new THREE.Texture (r.small.image);
      (o.generateMipmaps = !1), (o.wrapS = o.wrapT =
        THREE.ClampToEdgeWrapping), (o.minFilter =
        THREE.LinearFilter), (o.needsUpdate = !0);
      const s = {
  ...
  setCurrentTextures () {
    ...
    (this.uniforms.uImage.value =
      e.small.texture), (this.uniforms.uImageRes.value.x =
      e.small.texture.image.naturalWidth), (this.uniforms.uImageRes.value.y =
      e.small.texture.image.naturalHeight), (this.uniforms.uImageLarge.value =
      e.large.texture), (this.uniforms.uImageLargeRes.value.x =
      e.large.texture.image.naturalWidth), (this.uniforms.uImageLargeRes.value.y =
      e.large.texture.image.naturalHeight), this.isAnimating || this.render ();
  }
  init () {
    (this.renderer = new THREE.WebGLRenderer ({
      ...
      0.1,
      1e4
    )), (this.camera.position.z = 50), (this.camera.lookAt = this.scene.position);
    ...
    const t = (r = this.options.transformation.type) &&
    ...
    (this.mesh = new THREE.Mesh (n, o)), this.scene.add (
      this.mesh
    ), window.addEventListener ('resize', this.onResize), this.options
      .scrollContainer &&
  ...
  toGrid () {
    this.isFullscreen &&
      !this.isAnimating &&
      ((this.isAnimating = !0), this.options.onToGridStart &&
        ...
        this.options.timing.duration,
        {
          ...
          onComplete: () => {
            (this.isAnimating = !1), (this.isFullscreen = !1), (this.itemsWrapper.style.zIndex = 1), (this.container.style.zIndex = 0), this.resetUniforms (), this.render (), this
              .options.onToGridFinish &&
  ...
  recalculateUniforms (e) {
    if (-1 === this.currentImageIndex) return;
    const n = this.itemsWrapperChildren[
    ...
    (this.uniforms.uClosestCorner.value = r), (this.uniforms.uMouse.value = new THREE.Vector2 (
      t.x,
      t.y
    ));
    ...
    let c = a + o / 2, m = -l - s / 2;
    (u.position.x = c), (u.position.y = m), (this.uniforms.uPlaneCenter.value.x =
      c / o), (this.uniforms.uPlaneCenter.value.y =
      m /
      s), (this.uniforms.uMeshScale.value.x = o), (this.uniforms.uMeshScale.value.y = s), (this.uniforms.uScaleToViewSize.value.x =
      i.width / o - 1), (this.uniforms.uScaleToViewSize.value.y =
      i.height / s - 1);
  }
  toFullscreen (e, n) {
    if (!this.isFullscreen && !this.isAnimating) {
      if (
        ((this.isAnimating = !0), (this.currentImageIndex = e), this.recalculateUniforms (
          n
        ), this.textures[e])
      ) {
        const n = this.textures[e];
        (this.uniforms.uImage.value =
          n.small.texture), (this.uniforms.uImageRes.value.x =
          n.small.texture.image.naturalWidth), (this.uniforms.uImageRes.value.y =
          n.small.texture.image.naturalHeight), (this.uniforms.uImageLarge.value =
          n.large.texture), (this.uniforms.uImageLargeRes.value.x =
          n.large.texture.image.naturalWidth), (this.uniforms.uImageLargeRes.value.y =
          n.large.texture.image.naturalHeight);
      }
      (this.itemsWrapper.style.zIndex = 0), (this.container.style.zIndex = 2), this
        .options.onToFullscreenStart &&
        ...
        this.options.timing.duration,
        {
          ...
          onComplete: () => {
            (this.isAnimating = !1), (this.isFullscreen = !0), this.options
  ...
  onResize (e) {
    (this.camera.aspect =
      window.innerWidth /
      window.innerHeight), this.camera.updateProjectionMatrix (), this.renderer.setSize (
      window.innerWidth,
      window.innerHeight
    ), this.currentImageIndex > -1 &&
