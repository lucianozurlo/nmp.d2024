...
---------------------------------------------------*/
  ...
  window.ScrollEffects = function () {
    ...
    if ($ ('body').hasClass ('swap-logo')) {
      ...
      $ (
        'a.ajax-link, a.slide-link, a.next-ajax-link-page'
      ).on ('click', function () {
    ...
    gsap.utils.toArray ('.zoom-gallery').forEach (zoomGallery => {
      ...
      const zoomWrapperThumb = zoomGallery.querySelector (
        '.zoom-wrapper-thumb'
      );
    ...
    gsap.utils.toArray ('.news-shortcode').forEach (newsShortcode => {
      const newsPosts = Array.from (
        newsShortcode.querySelectorAll ('.news-post')
      );
    ...
    gsap.utils
      ...
      .forEach (listRotatorWrapper => {
        ...
        const listRotatorPin = listRotatorWrapper.querySelector (
          '.list-rotator-pin'
        );
    ...
    gsap.utils
      ...
      .forEach (clippedImageWrapper => {
        const clippedImagePin = clippedImageWrapper.querySelector (
          '.clipped-image-pin'
        );
        const clippedImage = clippedImageWrapper.querySelector (
          '.clipped-image'
        );
    ...
    for (var i = 0; i < panelsSections.length; i++) {
      ...
      gsap.set (thePanelsSection, {
        height: panelsContainer.offsetWidth -
          innerWidth +
    ...
    gsap.utils.toArray ('.slowed-pin').forEach (slowedPin => {
      ...
      const slowedTextWrapper = slowedPin.querySelector (
        '.slowed-text-wrapper'
      );
    ...
    imagesLoaded ('body', function () {
      ...
      if (window.innerWidth > 479) {
        ...
        pinnedSection.forEach (function (pinElement) {
          ...
          var scrollingElement = parentNode.querySelector (
            '.scrolling-element'
          );
      ...
      if (window.innerWidth > 767) {
        gsap.utils.toArray ('.vertical-parallax').forEach (parallaxElement => {
          var startMovement = -(parallaxElement.offsetHeight *
            parallaxElement.dataset.startparallax);
          var endMovement = -(parallaxElement.offsetHeight *
    ...
    $ ('.content-row.has-clip-path')
      .parent ()
      .parent ()
      .addClass ('clip-effects');
    ...
    if ($ ('.content-slider').length > 0) {
      ...
      $ ('.slider-button-prev')
        .mouseenter (function (e) {
          if (
            $ (this).parents ('.nmp-slider-wrapper').hasClass ('light-cursor')
          ) {
            ...
            $ (this).parents ('.nmp-slider-wrapper').hasClass ('dark-cursor')
          ) {
...
---------------------------------------------------*/
  ...
  window.PlayVideo = function () {
    if ($ ('.video-wrapper').length > 0) {
      ...
      var videocenter =
        ($ (window).height () - $ ('.video-cover').height ()) / 2;
...
---------------------------------------------------*/
  ...
  window.Core = function () {
    ...
    jQuery (document).ready (function () {
      var isAnimating = false, newLocation = '';
      firstLoad = false;

      //trigger smooth transition from the actual page to the new one
      $ ('main').on ('click', '[data-type="page-transition"]', function (
        event
      ) {
        event.preventDefault ();
      ...
      function loadNewContent (url, bool) {
        ...
        section.load (url + ' .cd-main-content > *', function (event) {
          ...
          var newPageRawHead = event.match (
            /<head[^>]*>([\s\S.]*)<\/head>/i
          )[0];
          ...
          setTimeout (function () {
            ...
            if (!isMobile () && !$ ('body').hasClass ('disable-cursor')) {
              ...
              $ ('.nmp-button .parallax-wrap.icon-wrap').mouseenter (function (
                e
              ) {
                gsap.to (ball, {
                  duration: 0.05,
